            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('dashboard')); ?>">
                        <div class="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center shadow-sm hover:bg-gray-700 transition duration-150">
                            <span class="text-white text-lg font-extrabold tracking-wider">CW</span>
                        </div>
                    </a>
                </div>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div title="<?php echo e(Auth::user()->name); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-500 hover:text-indigo-600 transition duration-150 ease-in-out" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
<?php /**PATH D:\Materi Kuliah\Semester 6\Aplikasi Berbasis Platform\Praktikum\Laprak\Week5\inventori-toko\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>