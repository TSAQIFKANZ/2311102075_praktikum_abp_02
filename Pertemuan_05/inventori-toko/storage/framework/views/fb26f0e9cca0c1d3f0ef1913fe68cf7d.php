...
<?php $component->withAttributes([]); ?>
    ...
    <div class="text-center mb-8 mt-2">
        <!-- Logo -->
        <div class="mx-auto w-16 h-16 bg-gray-800 rounded-2xl flex items-center justify-center shadow-md mb-4">
            <span class="text-white text-2xl font-bold tracking-wider">CW</span>
        </div>
        
        <!-- Judul -->
        <h2 class="text-2xl font-bold text-gray-800">Daftar Akun COKWO</h2>
        <p class="text-sm text-gray-600">Silakan buat akun baru untuk mengelola inventori</p>
    </div>
...
<?php endif; ?>
<?php /**PATH D:\Materi Kuliah\Semester 6\Aplikasi Berbasis Platform\Praktikum\Laprak\Week5\inventori-toko\resources\views/auth/register.blade.php ENDPATH**/ ?>