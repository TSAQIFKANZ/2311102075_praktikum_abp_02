...
<?php endif; ?>
    ...
    <div class="text-center mb-8 mt-2">
        ...
        <!-- Judul -->
        <h2 class="text-2xl font-bold text-gray-800">Masuk ke Toko COKWO</h2>
        <p class="text-sm text-gray-600">Silakan login untuk mengelola inventori</p>
    </div>
...
<?php endif; ?>
<?php /**PATH D:\Materi Kuliah\Semester 6\Aplikasi Berbasis Platform\Praktikum\Laprak\Week5\inventori-toko\resources\views/auth/login.blade.php ENDPATH**/ ?>